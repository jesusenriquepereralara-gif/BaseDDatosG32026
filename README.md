...
- Evolución de los archivos tradicionales a las Bases de Datos.
- Arquitectura ANSI-SPARC (tres niveles).
- Componentes y objetivos de un SGBD.
...
- Cardinalidad y participación:
  ...
  - 1:N
  - N:M
- Creación de diagramas conceptuales para representar la lógica del negocio.
...
- Claves Primarias (PK)
- Claves Foráneas (FK)
- Mapeo de entidades y relaciones hacia tablas físicas.
- Restricciones y acciones en cascada:
  - `ON DELETE`
  - `ON UPDATE`
...
📁 02_modelo_er/
│   └── Diagramas y casos de estudio

📁 03_modelo_relacional/
│   └── Ejercicios de mapeo

📁 04_sql_ldd/
│   └── Scripts de creación de esquemas (.sql)

📁 05_sql_lmd/
│   └── Scripts de consultas y manipulación (.sql)
